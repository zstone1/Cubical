import CubeChains.Precubical.Wedge.GeoTensor

/-!
# Precubical/Wedge/GeoTensor/Hom — the geometric tensor as a bifunctor on maps

The action of the computable geometric tensor (`Precubical/Wedge/GeoTensor`) on precubical maps:
