...
import CubeChains.Machinery.Presentation.CutGradedPresentation
...
`Concurrency/Presentation/LiftPresentation` transports to `Ch K`, not a rival to the Garside and
Artin presentations of the vertex monoids.
