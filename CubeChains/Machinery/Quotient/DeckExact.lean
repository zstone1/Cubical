import CubeChains.Machinery.Quotient.DeckSequence
import CubeChains.Machinery.Quotient.NerveQuot
import Mathlib.Algebra.Group.Subgroup.Ker

/-!
# Machinery/Quotient/DeckExact — the full short exact sequence of a regular groupoid covering
