...
the `Ch(Z)` presentation per run. What makes 6–7 short is
`Machinery/Localization/ActionPresentation.lean`: **a presented monoid presents its action
category**, for an arbitrary action, with no freeness hypothesis.
